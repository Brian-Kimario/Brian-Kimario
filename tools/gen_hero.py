...
DOSSIER = [
    ...
    ("Education", "Big Data Analytics · Chandigarh Univ.", TEXT),
    ("Role", "Data Engineer · Full-Stack", VIOLET),
    ("Focus", "Pipelines, warehouses, data quality", AMBER),
    None,
    ("#", "TOOLCHAIN", None),
    ("Core.Lang", "Python · TypeScript · SQL · Java", TEXT),
    ("Core.Flow", "Airflow 3 · Prefect · Astro Runtime", TEXT),
    ("Core.Store", "PostgreSQL · Supabase · DuckDB", TEXT),
    ("Core.Web", "Next.js 15 · FastAPI · Tailwind", TEXT),
    ("Core.Infra", "Docker · OrbStack · Vercel", TEXT),
    None,
    ("#", "SIGNAL", None),
    ("Certified", "IBM Java Fund. · Coursera Py4DS", MINT),
    ("Currently", "Airflow 3 · Prefect · DuckDB — building in public", TEXT),
